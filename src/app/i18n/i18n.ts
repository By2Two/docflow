...
export const TRANSLATIONS: Record<Locale, Translations> = {
  pt: {
    sidebar: {
      ...
      name: "Nome",
      namePlaceholder: "Ex: Eduardo Souza ou Empresa",
      ...
      author: "Autor",
      authorPlaceholder: "Ex: Eduardo Souza",
  ...
  en: {
    sidebar: {
      ...
      fileTypes: "PNG, JPG, SVG",
      name: "Name",
      namePlaceholder: "e.g. Nathalia Suzin or Company",
      ...
      author: "Author",
      authorPlaceholder: "e.g. Nathalia Suzin",
